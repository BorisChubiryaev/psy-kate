  ...
  return (
    <>
      ...
      >
        ...
        {/* Menu Panel */}
        <div
          className={`absolute top-16 left-0 right-0 glass-dark border-t border-white/10 transform transition-transform duration-300 liquid-gradient-dark ${
          ...
          <div className="max-w-7xl mx-auto px-4 py-6">
            <div className="space-y-1">
              <a
                ...
                className="mobile-nav-link py-4 text-lg"

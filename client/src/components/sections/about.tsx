          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="space-y-6 text-lg text-muted-foreground">
              <p data-testid="about-paragraph-1">
                Я — практикующий гештальт-психолог с глубоким пониманием
                человеческой природы и стремлением помочь людям найти гармонию с
                собой и окружающим миром.
              </p>
              <p data-testid="about-paragraph-2">
                Моя работа основана на принципах гештальт-терапии — подходе,
                который помогает осознать и интегрировать различные аспекты
                личности, проработать незавершенные ситуации и восстановить
                естественный поток жизненной энергии.
              </p>
              <p data-testid="about-paragraph-3">
                В своей практике я создаю безопасное пространство для
                исследования внутреннего мира, где каждый может открыть свои
                истинные потребности и найти ресурсы для позитивных изменений.
              </p>
            </div>

            <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div
                className="glass-dark p-6 rounded-xl glass-dark-hover"
              ...
              >
                ...
                <p className="text-muted-foreground">
                  Сертифицированный гештальт-психолог
                </p>
              </div>
              <div
                className="glass-dark p-6 rounded-xl glass-dark-hover"
